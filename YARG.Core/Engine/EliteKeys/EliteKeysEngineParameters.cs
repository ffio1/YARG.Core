...
{
    public class EliteKeysEngineParameters : BaseEngineParameters
    {
        public readonly double ChordStaggerWindow;

        public readonly double FatFingerWindow;

        public EliteKeysEngineParameters(HitWindowSettings hitWindow, int maxMultiplier, double spWhammyBuffer,
        ...
        public EliteKeysEngineParameters(ref FixedArrayStream stream, int version)
